...
def create_data(cancer_type, tcga_type):
    ...
    tcga_df = pd.read_table(input_folder + 'TCGA_FILES/TCGA_' + tcga_type + '_PREPROCESSED_MICROARRAY_EXPRESSION.tsv', index_col= 0)
    ...
    encoded_df.to_csv(output_folder + 'TCGA_MICROARRAY_' + tcga_type + '_PCA_500L.tsv', sep = '\t')
